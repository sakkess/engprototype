...
function App() {
  ...
  if (view === 'plan') {
    return (
      <div className="app-shell">
        <main className="study-card is-plan" aria-label="Study Plan">
          ...
          <ol className="chapter-list">
            {chapters.map((title, index) => (
              <li key={title} className="chapter-item">
                <button
                  className={`chapter-button ${index === activeChapterIndex ? 'is-active' : ''}`}
                  type="button"
  ...
  return (
    <div className="app-shell">
      <main className="study-card is-chapter" aria-label="Vocabulary Study Flow">
        <button type="button" className="plan-link" onClick={handleReturnToPlan}>
          ← Study Plan
        </button>
